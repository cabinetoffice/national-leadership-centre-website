...
window['ga-disable-{{ ga.ua }}'] = true;

// Variable to store 'Reset' of Google Analytics account
var _gaq = _gaq || [];
_gaq.push(['_setAccount', '{{ ga.ua }}']);
...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  document
    .getElementById('cookie-hide')
    .addEventListener('click', function (e) {
      // Enable Google Analytics when cookies accepted..
      window['ga-disable-{{ ga.ua }}'] = false;
...
$(document).ready(function () {
  ...
  $('.team-block__item__readmore').click(function () {
    $(this)
      .closest('.team-block__item')
      .find('.team-block__item__bio')
      .toggleClass('expand');

    var x = $(this)
      .closest('.team-block__item')
      .find('.team-block__item__readmore');
    ...
    $(this)
      .closest('.team-block__item')
      .find('.team-block__item__readmore__img')
      .toggleClass('rotate');
  });

  // Meet the team show/hide functionality
  $('.content-block__item__readmore').click(function () {
    $(this)
      .closest('.content-block__item')
      .find('.content-block__item__bio')
      .toggleClass('expand');

    var x = $(this)
      .closest('.content-block__item')
      .find('.content-block__item__readmore');
    ...
    $(this)
      .closest('.content-block__item')
      .find('.content-block__item__readmore__img')
      .toggleClass('rotate');
  });
